...
| Record Codex review | `python _bridge\codex_workflow_entry.py mirror contract-review --decision AGENTS.md=updated --decision README.md=compatible ... --summary <text> --confirm REVIEW-CODEX-MIRROR-CONTRACTS` | Writes, commits, pushes fingerprint-bound milestone evidence |
