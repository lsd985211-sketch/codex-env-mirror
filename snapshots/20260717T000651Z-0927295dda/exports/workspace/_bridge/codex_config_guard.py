...
def run_once(apply: bool, startup_delay_seconds: int = 0, phase: str = "manual") -> dict[str, Any]:
    ...
    if phase == "pre-start-static":
        ...
        result = {
            ...
            "policy": "static preflight performs merge-only baseline repair; session compaction is delegated to the stopped-process pre-launch owner and runtime checks remain in their owning phases",
        }
