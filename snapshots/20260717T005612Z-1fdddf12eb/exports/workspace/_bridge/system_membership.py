...
CONTRACTS: dict[str, dict[str, Any]] = {
    ...
    "hardware": generic_contract(
        ...
        [
            "do not mutate devices, drivers, firmware, storage, or operating-system device policy from a diagnostic owner",
...
IMPACT_RULES: list[dict[str, Any]] = [
    ...
    {"prefix": "_bridge/usb_device_owner", "systems": ["hardware"], "surfaces": ["contract_template", "impact_mapping", "maintenance_surface"], "reason": "Read-only USB device inventory, diagnostics, event evidence, or bounded observation behavior changed."},
