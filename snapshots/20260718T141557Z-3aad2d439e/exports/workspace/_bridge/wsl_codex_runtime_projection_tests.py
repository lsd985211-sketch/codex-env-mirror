...
class WslSessionProjectionSecurityTests(unittest.TestCase):
    ...
    def test_v1_manifest_forces_reprojection_after_context_transform_change(self) -> None:
        with tempfile.TemporaryDirectory() as raw:
            root = Path(raw)
            ...
            manifest.write_text(
                json.dumps(
                    {
                        "schema": "codex-wsl-session-projection.v1",
                        "files": {
                            "2026/thread.jsonl": {
    ...
    def test_session_projection_translates_every_resume_context_cwd(self) -> None:
        with tempfile.TemporaryDirectory() as raw:
            ...
            target.parent.mkdir()
            records = [
                {"type": "session_meta", "payload": {"id": "thread", "cwd": "C:\\Users\\45543\\Downloads\\mcsmanager_windows_release\\mcsmanager"}},
                {"type": "session_meta", "payload": {"id": "parent", "cwd": "C:\\Users\\45543\\Downloads\\mcsmanager_windows_release\\mcsmanager"}},
                {"type": "turn_context", "payload": {"cwd": "C:\\Users\\45543\\Downloads\\mcsmanager_windows_release\\mcsmanager"}},
