...
class ManagedPythonDependencyRuntimeTests(unittest.TestCase):
    ...
    def test_beautifulsoup_import_contract_uses_bs4(self) -> None:
        self.assertEqual(runtime.required_imports("beautifulsoup4"), ("bs4",))
        self.assertEqual(runtime.locked_dependency("beautifulsoup4")["version"], "4.15.0")
        lines = runtime.locked_requirement_lines("beautifulsoup4")
