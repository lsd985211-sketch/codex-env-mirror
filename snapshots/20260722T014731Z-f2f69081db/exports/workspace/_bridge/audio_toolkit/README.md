...
GUI forces CUDA for the `精修歌词/LRC` button. On Windows, Demucs/PyTorch downloads
are cached under `%LOCALAPPDATA%\Codex\audio\models\torch\` when this toolkit launches them.
