...
description: Multi-agent system design patterns for context isolation, supervisors, handoffs, agent coordination, and swarm-style workflows. Use for multi-agent architecture or collaboration design.
---
