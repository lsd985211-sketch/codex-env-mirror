...
from workflow_automation_delegation import compact_automation_delegation_policy
...
def _resource_gate(plan: dict[str, Any], domain_keys: list[str]) -> dict[str, Any]:
    ...
    return {
        ...
        "entrypoint": "_bridge/resource_cli.py custom --request-json <structured_task_envelope> --json",
        "submit_entrypoint": "_bridge/resource_cli.py custom --request-json <structured_task_envelope> --mode submit --json",
        ...
        "completion_contract": {
            ...
            "blocking_command": "python _bridge/resource_cli.py job run --task <task> --target <target> --json",
            ...
            "progress_command": "python _bridge/resource_cli.py job progress --request-id <request_id> --json",
            "status_command": "python _bridge/resource_cli.py job status --request-id <request_id> --json",
        },
        "ownership_contract": {
