...
def run_once(apply: bool, startup_delay_seconds: int = 0, phase: str = "manual") -> dict[str, Any]:
    ...
    if phase == "pre-start-static":
        ...
        result = {
            ...
            "before": before_audit,
            "repair": repair,
            "session_store_maintenance": {"ok": True, "skipped": True, "reason": "static_preflight"},
            ...
            "policy": "static merge-only startup baseline repair; runtime model, process, session, and network checks remain in their owning phases",
        }
