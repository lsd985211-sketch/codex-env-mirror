...
CONTRACTS: dict[str, dict[str, Any]] = {
    ...
    "wsl_workspace": {
        ...
        "member_kinds": ["workspace_lifecycle_owner", "declarative_work_git", "platform_projection", "isolated_validation_target"],
...
MIRROR_MEMBER_REGISTRY: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "owner": "wsl_workspace",
        "source_ids": ["workspace-bridge-source"],
        "generated_source_ids": ["wsl-workspace-bootstrap-receipt", "wsl-workspace-handoff-receipt", "wsl-work-git-release-receipt"],
        "change_roots": ["workspace:_bridge/wsl_workspace_owner.py", "workspace:_bridge/platform_paths.py", "workspace:_bridge/bootstrap_wsl_workspace.py", "workspace:WSL_WORKSPACE.md"],
    },
    {
...
IMPACT_RULES: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "systems": ["workflow"],
        "surfaces": ["contract_template", "workflow_route", "closeout_reconciliation", "maintenance_surface"],
        "reason": "Workspace Codex rules changed.",
    },
    {
    ...
    {"prefix": "_bridge/wsl_workspace_owner.py", "systems": ["wsl_workspace", "workflow", "backup"], "surfaces": ["identity", "lifecycle", "source_authority", "clone_bootstrap", "platform_projection", "validation", "handoff_receipt", "rollback", "maintenance_surface", "closeout"], "reason": "Long-lived WSL workspace lifecycle owner, work Git authority, platform projection, validation, or handoff behavior changed."},
    ...
    {"prefix": "_bridge/platform_paths.py", "systems": ["wsl_workspace", "startup", "workflow"], "surfaces": ["platform_projection", "execution_contract", "maintenance_regression", "closeout"], "reason": "Cross-platform workspace path resolution changed."},
