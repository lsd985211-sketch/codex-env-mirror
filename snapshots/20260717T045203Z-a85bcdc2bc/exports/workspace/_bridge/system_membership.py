...
CONTRACTS: dict[str, dict[str, Any]] = {
    ...
    "workflow": {
        ...
        "architecture_surfaces": ARCHITECTURE_SURFACES,
        "health_commands": [
            health_command("workflow_route", ["_bridge/workflow_orchestrator.py", "validate"], timeout=90),
            health_command("owner_facade", ["_bridge/workflow_owner_facade.py", "validate"], timeout=90),
            health_command("rule_governance", ["_bridge/rule_governance.py", "validate"], timeout=90),
        ],
        "non_goals": [
    ...
    "skills": generic_contract(
        ...
        [
            ...
            health_command("skill_router", ["_bridge/skill_orchestrator.py", "validate"], timeout=90),
        ],
...
MIRROR_MEMBER_REGISTRY: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "lifecycle": "active",
        "owner": "codex_cli",
        "source_ids": ["codex-version", "codex-model-catalog", "codex-config-template", "codex-global-state-template", "codex-scripts", "codex-tools", "codex-automations", "cc-switch-settings"],
        ...
        "change_roots": ["codex_home:version.json", "codex_home:cc-switch-model-catalog.json", "codex_home:config.toml", "codex_home:.codex-global-state.json", "codex_home:scripts/", "codex_home:tools/", "cc_switch:settings.json", "workspace:_bridge/"],
    },
    {
...
IMPACT_RULES: list[dict[str, Any]] = [
    ...
    {
        "prefix": "_bridge/codex_state_repair.py",
        "systems": ["startup", "mcp"],
        "surfaces": ["contract_template", "impact_mapping", "maintenance_surface", "runtime_exit"],
        "reason": "Startup baseline repair or Desktop-native MCP runtime-pointer reconciliation changed.",
    },
    {
