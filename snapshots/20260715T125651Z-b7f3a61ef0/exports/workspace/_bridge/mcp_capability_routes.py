...
MANUAL_ROUTES: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "native_mcp": "resource layer first for external acquisition; resource layer chooses context7|microsoftdocs|github|chrome-devtools|playwright by source type internally",
        ...
        "current_turn_evidence_rule": "explicit online research should first produce a resource-layer receipt. The resource layer should route Microsoft/Windows/Azure to microsoftdocs, libraries/SDKs/frameworks to Context7, repository facts to GitHub MCP, and page/runtime evidence to browser/devtools/playwright; generic web search must have a resource-layer terminal blocker or fallback reason",
    },
    {
...
def validate() -> dict[str, Any]:
    ...
    for profile in ("context7", "microsoftdocs"):
