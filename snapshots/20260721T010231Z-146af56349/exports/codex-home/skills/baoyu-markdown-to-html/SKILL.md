...
- Confirm the input is markdown and whether CJK formatting should be normalized first.
- Decide the theme before conversion.
- Check for output file conflicts before writing HTML.

## Output Contract

- Return the HTML path, theme, and backup path if created.
- Mention whether markdown formatting was preserved or intentionally changed.
- State if the conversion was theme-only or preceded by markdown cleanup.
