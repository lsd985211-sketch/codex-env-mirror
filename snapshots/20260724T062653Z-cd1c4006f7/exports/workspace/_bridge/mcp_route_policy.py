...
KNOWN_TOOL_DISCOVERY_QUERIES: dict[str, str] = {
    ...
    "gitnexus": "gitnexus list_tools call semantic code flow context trace impact MCP",
    "graphify": "graphify list_tools call managed graph query review analysis MCP",
    "headroom": "headroom compress retrieve stats context JSON logs code tool output MCP",
}
...
KNOWN_DIRECT_HUB_TOOLS: dict[str, list[str]] = {
    ...
    "gitnexus": ["gitnexus.list_tools", "gitnexus.call"],
    "gitnexus_semantic_graph": ["gitnexus.list_tools", "gitnexus.call"],
    "graphify": ["graphify.list_tools", "graphify.call"],
    "graphify_knowledge_graph": ["graphify.list_tools", "graphify.call"],
    "headroom": ["headroom.compress", "headroom.retrieve", "headroom.stats"],
    "context_compression": ["headroom.compress", "headroom.retrieve", "headroom.stats"],
...
DIRECT_HUB_TOOL_BY_NATIVE: dict[tuple[str, str], str] = {
    ...
    ("headroom", "compress"): "headroom.compress",
    ("headroom", "retrieve"): "headroom.retrieve",
    ("headroom", "stats"): "headroom.stats",
...
DIRECT_HUB_CALL_HINTS: dict[str, dict[str, Any]] = {
    ...
    "gitnexus": {
        "hub_tool": "gitnexus.list_tools|gitnexus.call",
        "profile": "gitnexus",
        "typical_tools": ["gitnexus.list_tools", "gitnexus.call"],
        "requires": ["Hub tool discovery or hub.call acknowledgement", "read-only upstream GitNexus tool and bounded arguments"],
        "why_not_complete_route": "the Hub exposes a bounded read-only GitNexus adapter; hub.call reaches it when an active turn has stale tool metadata",
    },
    "graphify": {
        "hub_tool": "graphify.list_tools|graphify.call",
        "profile": "graphify",
        "typical_tools": ["graphify.list_tools", "graphify.call"],
        "requires": ["Hub tool discovery or hub.call acknowledgement", "managed graph.json and an allowlisted read-only Graphify tool"],
        "why_not_complete_route": "the Hub exposes a bounded read-only Graphify adapter; hub.call reaches it when an active turn has stale tool metadata",
    },
}
...
def common_direct_hub_options() -> dict[str, list[str]]:
    return {
        ...
        "gitnexus": list(KNOWN_DIRECT_HUB_TOOLS["gitnexus"]),
        "graphify": list(KNOWN_DIRECT_HUB_TOOLS["graphify"]),
...
def route_contract_check(policy: dict[str, Any] | None = None) -> dict[str, Any]:
    ...
    affinity_cases = {
        ...
        "gitnexus": (execution_affinity("gitnexus", "call", "gitnexus_semantic_graph"), "hub_first", "none"),
        "graphify": (execution_affinity("graphify", "call", "graphify_knowledge_graph"), "hub_first", "none"),
    ...
    first_step_cases = {
        ...
        "gitnexus": (call_priority_pack("gitnexus", "call", "gitnexus_semantic_graph"), "hub_mcp_direct"),
        "graphify": (call_priority_pack("graphify", "call", "graphify_knowledge_graph"), "hub_mcp_direct"),
