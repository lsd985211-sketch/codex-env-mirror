...
RESOURCE_RULES: tuple[ResourceRule, ...] = (
    ...
    ResourceRule(
        ...
        read_tools=("_bridge/resource_cli.py job run --intent package_dependency --auto-owner --json",),
...
def build_route(message: str) -> dict[str, Any]:
        ...
        owner_routes.append(
            {
                ...
                "read_tools_first": [
                    "_bridge/resource_cli.py delegate --json",
                    "_bridge/resource_cli.py route --json",
    ...
    return {
        ...
        "resource_layer_contract": {
            ...
            "entrypoint": "_bridge/resource_cli.py delegate --json",
            "submit_entrypoint": "_bridge/resource_cli.py job run --json",
