...
| OCR venvs | `_bridge\venvs\ocr-py312`, `_bridge\venvs\ocr-gpu-py312` with `paddleocr`, `paddle`, `opencv`, `modelscope`; GPU venv also has `PyMuPDF` | Use purpose-built OCR/GUI helpers before raw imports. |
