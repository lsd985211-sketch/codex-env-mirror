...
- Confirm the story length, art style, tone, and layout before generating.
- Build character consistency first when the comic depends on recurring roles.
- Load preferences before any style-specific question.

## Output Contract

- Return the storyboard, character refs, and final PDF path.
- State whether the output is verified, candidate, or regenerated.
- Mention any page consistency or character reference risk.
