...
def reconcile(
    *,
    ...
    if not startup_baseline.get("ok"):
        return {**result, "reason": "startup_baseline_repair_failed"}
    native_runtime = (
        ...
        return {
            **result,
            ...
            "reason": (
                ...
                else "native_provider_without_catalog_no_runtime_override_required"
...
def runtime_binding_state(
    ...
    if native_runtime.get("native_authoritative"):
        ...
        bound = bool(legacy.get("ok")) and not bool(legacy.get("skipped")) and not legacy_present
        return {
            ...
            "reason": "native_runtime_clean" if bound else str(legacy.get("reason") or "legacy_runtime_shims_present"),
        }
