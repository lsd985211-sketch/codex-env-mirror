...
def main(argv: list[str] | None = None) -> int:
    ...
    for name in ("plan", "preflight"):
        ...
        if name == "plan":
            p.add_argument("--owner", choices=["resource", "email", "maintenance", "mcp", "mobile", "network", "office", "wsl_workspace"], default="")
    ...
    run.add_argument("--owner", choices=["resource", "email", "maintenance", "mcp", "mobile", "network", "office", "wsl_workspace"], default="")
