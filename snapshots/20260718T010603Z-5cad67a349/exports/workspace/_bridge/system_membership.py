...
CONTRACTS: dict[str, dict[str, Any]] = {
    ...
    "wsl_workspace": {
        ...
        "required_surfaces": [
            ...
            surface("lifecycle", "wsl_workspace owner", "status, plan, bootstrap, validate, handoff, and cleanup-plan are reusable lifecycle operations", "python _bridge\\wsl_workspace_owner.py validate"),
            surface("source_authority", "wsl_workspace owner", "daily authority is the local declarative work Git repository; mirror is recovery/release source", "owner snapshot and handoff receipt"),
...
MIRROR_MEMBER_REGISTRY: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "lifecycle": "active",
        "owner": "codex_cli",
        "source_ids": ["codex-version", "codex-model-catalog", "codex-config-template", "codex-hooks", "codex-global-state-template", "codex-scripts", "codex-tools", "codex-automations", "cc-switch-settings"],
        ...
        "change_roots": ["codex_home:version.json", "codex_home:cc-switch-model-catalog.json", "codex_home:config.toml", "codex_home:hooks.json", "codex_home:.codex-global-state.json", "codex_home:scripts/", "codex_home:tools/", "cc_switch:settings.json", "workspace:_bridge/"],
    },
    {
    ...
    },
    {
        ...
        "owner": "wsl_workspace",
        "source_ids": ["workspace-bridge-source"],
        "generated_source_ids": ["wsl-workspace-bootstrap-receipt", "wsl-workspace-handoff-receipt"],
