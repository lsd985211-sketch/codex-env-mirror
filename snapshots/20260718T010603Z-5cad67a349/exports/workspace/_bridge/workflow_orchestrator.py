...
DOMAINS: tuple[Domain, ...] = (
    ...
    Domain(
        "wsl_workspace",
        "long-lived WSL work Git workspace and platform projection lifecycle",
        (
            "WSL",
            "wsl",
            "Linux工作区",
        ...
        ("global-framework", "codex-environment-mirror"),
        ("wsl-workspace-flow",),
        ("wsl_workspace", "codex_environment_mirror", "system_membership"),
        ("_bridge/wsl_workspace_owner.py", "_bridge/codex_environment_mirror.py", "_bridge/system_membership.py"),
        (
            ...
            "python _bridge\\wsl_workspace_owner.py handoff",
            "python _bridge\\wsl_workspace_owner.py cleanup-plan",
        ),
    ),
    Domain(
        "memory",
