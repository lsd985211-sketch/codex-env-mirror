...
def execute(action: str, *, target_root: str = "", confirm: str = "", changed_paths: list[str] | None = None, left_snapshot: str = "", right_snapshot: str = "", remote: str = "", branch: str = "", tag: str = "", title: str = "", release_impact: str = "") -> dict[str, Any]:
    if action == "status":
        return status()
    if action == "doctor":
        return doctor()
