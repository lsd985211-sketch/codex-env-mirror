...
- Confirm the source article and the intended angle before writing.
- Extract the core idea before drafting prose.
- Keep the review grounded in the source, not in invented background.

## Output Contract

- Return the article angle, main argument, and any source-dependent caveats.
- Preserve the source's key claims without turning into a summary-only output.
- If background facts are uncertain, mark them as such.
