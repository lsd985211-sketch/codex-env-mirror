...
- Confirm the target file(s), desired format, and whether originals should be kept.
- Prefer lossless or least-destructive settings when the user has not asked otherwise.
- Check output path conflicts before compressing.

## Output Contract

- Return the before/after size and format result.
- Mention whether the original was preserved.
- State if the run was recursive or single-file.
