...
ARCHIVE_ROOT = BRIDGE_ROOT / "backups" / "archive"
        ...
        actions.append(
            {
                ...
                "dry_run_only": True,
                "would_mutate": "move old *.bak-* files from source directories into _bridge/backups/archive/YYYYMM preserving relative paths",
                ...
                "guardrails": [
                    ...
                    "do not touch files outside _bridge",
                ],
...
def validate(snapshot: dict[str, Any] | None = None) -> dict[str, Any]:
    ...
    return {
        ...
        "ok": bool(snap.get("ok")) and bool(plan.get("dry_run_contract", {}).get("deletes_files") is False),
        "generated_at": now_iso(),
        "backup_count": (snap.get("summary") or {}).get("backup_count"),
        "dry_run_only": True,
        "note": "Validation confirms backup hygiene is observable and repair-plan does not mutate files.",
    }
