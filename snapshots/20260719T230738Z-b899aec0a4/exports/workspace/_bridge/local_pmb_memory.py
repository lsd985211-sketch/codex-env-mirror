...
from platform_paths import codex_home, resource_library_root, worktree_root
...
PMB_RUNTIME_BRIDGE_ROOT = local_pmb_memory_platform.runtime_bridge_root(BRIDGE_ROOT)
PMB_VENV = PMB_RUNTIME_BRIDGE_ROOT / "venvs" / "pmb-memory"
...
MEMORY_ROOT = resource_library_root() / "memory"
