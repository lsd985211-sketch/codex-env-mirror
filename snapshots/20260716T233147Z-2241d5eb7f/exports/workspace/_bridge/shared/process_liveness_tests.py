...
try:
    from shared.process_liveness import find_unsafe_zero_signal_probes, normalize_pid, process_is_alive
except ModuleNotFoundError:
    from _bridge.shared.process_liveness import find_unsafe_zero_signal_probes, normalize_pid, process_is_alive
