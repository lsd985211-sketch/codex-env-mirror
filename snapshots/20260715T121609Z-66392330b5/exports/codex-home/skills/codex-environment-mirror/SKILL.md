...
- Keep secrets, cookies, sessions, runtime databases, logs, caches, archives,
  and large binaries outside Git.
- Mirror only active recoverable capability. Inactive member records and
  historical backup directories must not enter snapshots.
