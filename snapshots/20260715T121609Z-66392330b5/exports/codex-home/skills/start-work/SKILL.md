...
| 文件 | 路径 | 目的 |
|------|------|------|
| 收件箱 | `<OBSIDIAN_ROOT>/00 收件箱/` | 检查待处理项 |
| 年度计划 | `<OBSIDIAN_ROOT>/06 计划/2026年计划.md` | 获取周计划 |
| 周写作计划 | `<OBSIDIAN_ROOT>/06 计划/2026年第4周写作计划.md` | 获取本周文章列表 |
| 选题库 | `<OBSIDIAN_ROOT>/选题库/待写选题.md` | 获取待写选题 |
| L1情境层 | `<OBSIDIAN_ROOT>/AI_MEMORY/L1_情境层/` | 查看近期记录 |
| 核心价值观 | `<OBSIDIAN_ROOT>/AI_MEMORY/L4_核心层/核心价值观.md` | 激励语素材 |
