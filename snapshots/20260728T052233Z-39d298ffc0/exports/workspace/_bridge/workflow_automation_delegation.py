...
POLICY_SCHEMA = f"{POLICY_SCHEMA_FAMILY}.v8"
...
POLICY = {
    ...
    "live_contract_preconditions": {
        "tool_schema_authority": "App, MCP, and owner CLI calls consume the current exposed schema or owner contract; remembered fields and copied examples are not authoritative.",
        ...
        "thread_coordination": "Cross-task coordination and closeout delegation require current Codex App evidence for a same-repository active target; idle, notLoaded, completed, archived, foreign, and current tasks are excluded.",
