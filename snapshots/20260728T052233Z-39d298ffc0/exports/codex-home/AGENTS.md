...
- Approval-facing documents default to Chinese as their primary language, including design specifications, implementation plans, repair or migration plans, risk reports, and change proposals. Use Chinese for titles, explanations, conclusions, risks, options, recommendations, review items, acceptance criteria, and next actions. Preserve exact code, commands, paths, configuration keys, environment variables, protocol fields, schema names, API identifiers, product names, and external quotations. Machine-readable files and source code do not require Chinese, but their user-facing approval summaries do. An explicit user language request or an external format contract overrides this default.
