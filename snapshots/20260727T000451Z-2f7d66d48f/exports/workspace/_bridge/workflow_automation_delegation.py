...
POLICY_SCHEMA = f"{POLICY_SCHEMA_FAMILY}.v6"
...
POLICY = {
    ...
    "long_command_contract": {
        "preference_order": ["consume_native_process_or_session_handle", "submit_once_and_follow_durable_receipt"],
        ...
        "follow": "consume one quiet follow process through its native handle until exit; compact output preserves terminal state, exit code, and raw artifact references",
