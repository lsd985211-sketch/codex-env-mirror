...
def health_command(name: str, args: list[str], *, severity: str = "risk", timeout: int = 60) -> dict[str, Any]:
    return {"name": name, "args": args, "severity": severity, "timeout": timeout}
...
CONTRACTS: dict[str, dict[str, Any]] = {
    ...
    "bridge": generic_contract(
        ...
        [
            health_command("mobile_bridge", ["_bridge/mobile_openclaw_bridge/mobile_openclaw_cli.py", "maintenance", "doctor"], severity="advisory", timeout=90),
    ...
    "startup": generic_contract(
        "startup",
        ["guard", "launcher", "baseline", "session_store"],
        [
            health_command("config_guard", ["_bridge/codex_config_guard.py", "validate"], timeout=90),
            health_command("session_store", ["_bridge/codex_session_store_doctor.py", "doctor"], timeout=90),
        ],
...
IMPACT_RULES: list[dict[str, Any]] = [
    ...
    {"prefix": "_bridge/codex_session_store_doctor.py", "systems": ["startup"], "surfaces": ["contract_template", "impact_mapping", "maintenance_surface"], "reason": "Session restore maintenance changed."},
