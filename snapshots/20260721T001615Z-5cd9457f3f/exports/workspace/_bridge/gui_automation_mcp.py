...
OCR_PYTHON = Path(os.environ.get("GUI_OCR_PYTHON", str(ROOT / "venvs" / "ocr-py312" / "Scripts" / "python.exe")))
OCR_FALLBACK_PYTHON = Path(os.environ.get("GUI_OCR_FALLBACK_PYTHON", str(ROOT / "venvs" / "ocr-py312" / "Scripts" / "python.exe")))
