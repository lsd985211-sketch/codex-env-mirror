...
SESSION_PROJECTION_SCHEMA = "codex-wsl-session-projection.v5"
    ...
    if write:
        for source in source_files:
            ...
            if (
                ...
                if (
                    destination.stat().st_size == expected_target_size
        ...
        previous_projected_paths = {
            str(value.get("projected_relative") or relative) if isinstance(value, dict) else str(relative)
