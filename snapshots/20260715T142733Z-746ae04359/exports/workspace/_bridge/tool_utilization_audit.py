...
Caller context: workflow validation, closeout diagnostics, and user-requested
tool utilization reviews.
"""
...
AUDIT_CASES: tuple[dict[str, Any], ...] = (
    {
        ...
        "expect_policy": ("codegraph_policy", "maintenance_upgrade_policy", "tool_utilization_policy"),
    ...
    },
    {
        ...
        "expect_policy": ("network_policy", "tool_utilization_policy"),
