...
def external_runtime_field_paths(target: str) -> tuple[tuple[str, ...], ...]:
    """Expose the declared runtime-owned config fields to sibling owners."""

    return tuple(_external_runtime_field_paths(target))
