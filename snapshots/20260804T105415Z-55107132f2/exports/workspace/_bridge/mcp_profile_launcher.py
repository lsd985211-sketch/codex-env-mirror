...
NODE = Path("C:/Program Files/nodejs/node.exe") if sys.platform == "win32" else Path(shutil.which("node") or "node")
NODE_DIR = NODE.parent
NPX_CLI = (
    Path("C:/Program Files/nodejs/node_modules/npm/bin/npx-cli.js")
    if sys.platform == "win32"
    else Path("/usr/lib/node_modules/npm/bin/npx-cli.js")
)
