...
from workflow_automation_delegation import single_authority_plan_check
...
def automation_delegation_semantics(build_plan: BuildPlan) -> dict[str, Any]:
    ...
    ok = (
        policy.get("schema") == "workflow_automation_delegation.v4"
        and route_policy.get("schema") == "workflow_automation_delegation.v4"
