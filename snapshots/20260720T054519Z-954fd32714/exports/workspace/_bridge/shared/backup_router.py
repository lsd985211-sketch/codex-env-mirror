...
def plan(paths: list[str], *, remark: str = DEFAULT_REMARK, purpose: str = "", category: str = "") -> dict[str, Any]:
    ...
    return {
        ...
        "ok": all(item["exists"] and item["is_file"] and item["destination_policy_ok"] for item in items),
...
def create_backup(
    ...
    *,
    ...
    if not planned.get("ok"):
        ...
        reason = "backup_destination_inside_git_worktree" if destination_blocked else "one_or_more_sources_missing_or_not_files"
