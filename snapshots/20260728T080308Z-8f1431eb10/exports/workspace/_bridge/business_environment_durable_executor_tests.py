...
from business_environment_durable_executor_process import advance_operation, build_operation, validate
...
class DurableExecutorTests(unittest.TestCase):
    def test_owner_validate_uses_the_real_convergence_plan_contract(self) -> None:
        result = validate()
