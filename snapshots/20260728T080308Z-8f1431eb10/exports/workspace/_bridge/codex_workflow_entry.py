...
def main(argv: list[str] | None = None) -> int:
    ...
    c.add_argument("--active-workspace-thread", action="append", default=[], help="Structured current Codex App thread-state JSON: threadId, status=active, sameRepository=true, currentTask=false; repeat as needed.")
    ...
    if args.command == "plan":
        ...
        if (
            ...
            if args.mirror_action in {"release", "release-authorization-plan"}:
