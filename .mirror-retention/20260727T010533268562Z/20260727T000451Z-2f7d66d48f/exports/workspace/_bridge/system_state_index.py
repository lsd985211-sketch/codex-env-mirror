...
SIGNAL_COMMANDS: tuple[SignalCommand, ...] = (
    SignalCommand("state_write_authority.validate", "workflow", "state_write_authority", (PYTHON_EXECUTABLE, "_bridge/state_write_authority.py", "validate")),
    SignalCommand("email_scheduler.metrics", "email", "email_scheduler", (PYTHON_EXECUTABLE, "_bridge/shared/email_scheduler.py", "metrics")),
    SignalCommand("record_store.metrics", "record_store", "record_store_maintenance", (PYTHON_EXECUTABLE, "_bridge/shared/record_store_maintenance.py", "metrics")),
    SignalCommand("record_store.query", "record_store", "record_store_maintenance", (PYTHON_EXECUTABLE, "_bridge/shared/record_store_maintenance.py", "query", "--limit", "20")),
    SignalCommand("local_mcp_hub.validate", "mcp", "local_mcp_hub", (PYTHON_EXECUTABLE, "_bridge/local_mcp_hub.py", "validate")),
    SignalCommand("mcp_session.validate", "mcp", "mcp_session_doctor", (PYTHON_EXECUTABLE, "_bridge/mcp_session_doctor.py", "validate")),
    SignalCommand("network_gateway.validate", "network", "codex_network_gateway", (PYTHON_EXECUTABLE, "_bridge/codex_network_gateway.py", "validate")),
    SignalCommand("workflow.validate", "workflow", "workflow_orchestrator", (PYTHON_EXECUTABLE, "_bridge/workflow_orchestrator.py", "validate")),
    SignalCommand(
        "workflow_observation_iteration.plan",
        "workflow_evolution",
        "workflow_observation_iteration",
        (PYTHON_EXECUTABLE, "_bridge/workflow_observation_iteration.py", "plan"),
    ),
    SignalCommand("code_maintainability.validate", "code", "code_maintainability", (PYTHON_EXECUTABLE, "_bridge/code_maintainability.py", "validate")),
)
