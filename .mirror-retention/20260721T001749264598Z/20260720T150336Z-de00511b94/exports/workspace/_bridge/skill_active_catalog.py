...
def catalog_snapshot(
    *,
    ...
    """Return bounded evidence about configured plugin discovery."""
    ...
    return {
        ...
        "ok": config_path.is_file() and all(item["available"] for item in roots),
        ...
        "exclusion_rule": "only enabled config plugins and one current version per plugin; backup/staging paths are never active",
    }
