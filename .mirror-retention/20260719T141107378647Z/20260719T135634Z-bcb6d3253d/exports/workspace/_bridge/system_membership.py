...
CONTRACTS: dict[str, dict[str, Any]] = {
    "mcp": {
        ...
        "architecture_surfaces": ARCHITECTURE_SURFACES,
        "health_commands": [health_command("mcp_session", ["_bridge/mcp_session_doctor.py", "validate"], timeout=90)],
        "non_goals": [
    ...
    "hardware": generic_contract(
        ...
        [
            health_command("windows_hardware_owner", ["_bridge/windows_hardware_owner.py", "validate"], timeout=45),
            health_command("usb_device_owner", ["_bridge/usb_device_owner.py", "validate"], timeout=90),
            health_command("usb_device_control", ["_bridge/usb_device_control.py", "validate"], timeout=45),
        ],
        [
    ...
    "audio": generic_contract(
        ...
        [
            health_command("music_library_owner", ["_bridge/music_library_owner.py", "validate"], timeout=90),
            health_command("audio_toolkit", ["_bridge/audio_toolkit/audio_toolkit.py", "validate"], timeout=30),
        ],
        [
    ...
    "mail": generic_contract(
        ...
        [health_command("email_scheduler", ["_bridge/shared/email_scheduler.py", "validate"], timeout=90)],
    ...
    "records": generic_contract(
        ...
        [health_command("record_store", ["_bridge/shared/record_store_maintenance.py", "doctor"], timeout=90)],
    ...
    "startup": generic_contract(
        "startup",
        ["guard", "launcher", "baseline", "config_projection", "session_store"],
        [
            health_command("config_guard", ["_bridge/codex_config_guard.py", "validate"], timeout=90),
            health_command("config_projection", ["_bridge/codex_config_projection.py", "validate"], timeout=45),
            health_command(
                "session_store",
    ...
    "wsl_workspace": {
        ...
        "member_kinds": ["workspace_lifecycle_owner", "developer_toolchain_owner", "work_git_change_owner", "declarative_work_git", "platform_projection", "host_compatibility_projection", "isolated_validation_target"],
        ...
        "required_surfaces": [
            ...
            surface("lifecycle", "wsl_workspace owner", "status, plan, bootstrap, validate, handoff, cleanup-plan, and work-Git release-readiness are reusable lifecycle operations", "python _bridge\\wsl_workspace_owner.py validate"),
            ...
            surface("rollback", "wsl_workspace owner", "cleanup is explicit and never removes the default WSL distribution, mirror, or host runtime", "python _bridge\\wsl_workspace_owner.py cleanup-plan"),
...
MIRROR_MEMBER_REGISTRY: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "lifecycle": "active",
        "owner": "codex_cli",
        "source_ids": ["codex-version", "codex-model-catalog", "codex-config-template", "wsl-codex-config-template", "codex-hooks", "codex-global-state-template", "codex-scripts", "codex-tools", "codex-automations", "cc-switch-settings"],
        "generated_source_ids": ["runtime-versions", "windows-scheduled-tasks", "windows-shortcuts", "secret-requirement-snapshot", "cc-switch-semantic-export", "codex-plugin-inventory"],
        "change_roots": ["codex_home:version.json", "codex_home:cc-switch-model-catalog.json", "codex_home:config.toml", "work_git:codex-home/config.wsl.template.toml", "codex_home:hooks.json", "codex_home:.codex-global-state.json", "codex_home:scripts/", "codex_home:tools/", "cc_switch:settings.json", "workspace:_bridge/"],
    },
    {
    ...
    },
    {
        ...
        "generated_source_ids": ["mcp-route-snapshot"],
    ...
    },
    {
        ...
        "change_roots": ["worktree:AGENTS.md", "workspace:AGENTS.md", "workspace:_bridge/wsl_workspace_owner.py", "workspace:_bridge/platform_paths.py", "workspace:_bridge/bootstrap_wsl_workspace.py", "worktree:WSL_WORKSPACE.md"],
    },
    {
    ...
    },
    {
        ...
        "source_ids": ["workspace-bridge-source", "wsl-codex-config-template", "codex-scripts"],
        ...
        "change_roots": [
            ...
            "work_git:codex-home/config.wsl.template.toml",
...
IMPACT_RULES: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "systems": ["mcp"],
        "surfaces": ["hub_adapter", "derived_route_index", "diagnostics"],
        "reason": "Hub core or a purpose-owned Hub adapter changed.",
    },
    {
    ...
    {"prefix": "_bridge/wsl_workspace_owner.py", "systems": ["wsl_workspace", "workflow", "backup", "startup"], "surfaces": ["identity", "lifecycle", "source_authority", "desktop_project_registration", "host_compatibility_projection", "clone_bootstrap", "platform_projection", "validation", "handoff_receipt", "rollback", "maintenance_surface", "closeout"], "reason": "Long-lived WSL workspace lifecycle owner, Desktop project registration, Work Git authority, host compatibility projection, validation, or handoff behavior changed."},
    ...
    {"prefix": "_bridge/code_maintainability_toolchain.py", "systems": ["wsl_workspace", "workflow"], "surfaces": ["developer_toolchain", "validation", "maintenance_regression", "maintenance_surface"], "reason": "Developer toolchain requirement or version probe behavior changed."},
    ...
    {"prefix": "_bridge/windows_hardware_", "systems": ["hardware"], "surfaces": ["contract_template", "impact_mapping", "maintenance_surface", "workflow_route", "maintenance_regression"], "reason": "Global read-only Windows hardware inventory, diagnostics, evidence, or routing changed."},
    ...
    {"prefix": "_bridge/shared/record_store_maintenance.py", "systems": ["records"], "surfaces": ["contract_template", "impact_mapping", "maintenance_surface"], "reason": "Record index, retention, or archive behavior changed."},
...
def validate() -> dict[str, Any]:
    ...
    for key in ("admission_rule", "change_propagation_rule", "reconciliation_rule", "closeout_enforcement_rule"):
