...
def validate(args: argparse.Namespace) -> dict[str, Any]:
    ...
    placement_gate_ok = (
        ...
        and placement_sample.get("new_module_name") == "_bridge\\local_mcp_hub_process.py"
    ...
    existing_detail_ok = (
        ...
        and existing_detail_sample.get("existing_purpose", {}).get("match", {}).get("module")
    ...
    resource_scheduler_ok = (
        resource_scheduler_sample.get("owner_module") == "_bridge\\resource_scheduler.py"
        and resource_scheduler_sample.get("existing_purpose", {}).get("match", {}).get("module")
...
def lookup_existing_purpose_module(args: argparse.Namespace, target: str) -> dict[str, Any]:
    ...
    for match in lookup.get("matches", []):
        module = str(match.get("module") or "").replace("/", "\\").lower()
