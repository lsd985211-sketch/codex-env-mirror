...
def compact_execution_route_pack(plan: dict[str, Any], detail: str) -> dict[str, Any]:
    ...
    if detail == "micro":
        ...
        # available through --detail standard/full when needed.
        result = {
...
def apply_detail_level(plan: dict[str, Any], detail_level: str) -> dict[str, Any]:
    ...
    return bounded_payload(
        ...
        max_items=16,
        max_string=500,
        preserve_keys=("schema", "ok", "generated_at", "detail_level", "profile", "domains", "retirement_guard", "structured_route", "execution_route_pack"),
    )
