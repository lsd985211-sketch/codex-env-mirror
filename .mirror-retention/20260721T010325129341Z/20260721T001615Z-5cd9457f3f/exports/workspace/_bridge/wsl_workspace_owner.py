...
def mirror_export(args: argparse.Namespace) -> dict[str, Any]:
    ...
    return {
        ...
        "error": {
            ...
            "allowed": ["bootstrap", "handoff", "work-git-release", "desktop-project-registration", "codex-app-server-status", "codex-app-server-unit"],
        },
        "activation_performed": False,
        "host_runtime_imported": False,
        "default_distribution_change": False,
...
def main(argv: list[str] | None = None) -> int:
    ...
    export.add_argument(
        "--kind",
        choices=("bootstrap", "handoff", "work-git-release", "desktop-project-registration", "codex-app-server-status", "codex-app-server-unit"),
        required=True,
    )
