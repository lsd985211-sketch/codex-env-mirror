...
示例:
  python query_session.py 90f05e0c-5d08-4148-be40-e30fc7c7bedf
  python query_session.py 90f05e0c-5d08-4148-be40-e30fc7c7bedf --after-seq 5
  python query_session.py SESSION_ID --project-id PROJECT_UUID   # 结果中附带 projectUrl
        """,
