...
- Confirm the cover type, palette, rendering, text level, and mood before generating.
- Decide whether the title is required or intentionally omitted.
- Load preferences before asking style questions.

## Output Contract

- Return the chosen dimensions and output path.
- State whether the prompt was generated from source text, reference images, or auto-selection.
- Mention any backup or regenerate actions explicitly.
