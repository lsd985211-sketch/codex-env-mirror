...
- Confirm the source is an article or long-form page, not a library doc or generic scrape.
- Capture the source content first, then translate.
- Keep translation and source extraction separate so the original structure stays inspectable.
...
- Report the saved path, translation scope, and any missing image or formatting fidelity.
- Preserve code blocks, headings, and links unless the user asks otherwise.
