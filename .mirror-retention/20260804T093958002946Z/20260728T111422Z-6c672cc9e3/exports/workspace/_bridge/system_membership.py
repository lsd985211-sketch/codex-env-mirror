...
MIRROR_MEMBER_REGISTRY: list[dict[str, Any]] = [
    {
        ...
        "change_roots": ["workspace:_bridge/scoped_authorization.py", "workspace:_bridge/scoped_authorization_environment.py", "workspace:_bridge/authorization_environment_provider.py", "workspace:_bridge/execution_route_pack.py", "workspace:_bridge/workflow_plan_detail.py", "workspace:_bridge/shared/scheduler_authorization.py", "workspace:_bridge/shared/codex_scheduler_runner.py", "workspace:_bridge/workflow_review_delivery.py", "workspace:_bridge/codex_environment_mirror.py", "workspace:_bridge/codex_workflow_entry.py"],
    },
    {
    ...
    },
    {
        ...
        "change_roots": ["worktree:AGENTS.md", "workspace:AGENTS.md", "workspace:_bridge/wsl_workspace_owner.py", "workspace:_bridge/wsl_workspace_generated_artifacts.py", "workspace:_bridge/wsl_interop_guard.py", "workspace:_bridge/platform_paths.py", "workspace:_bridge/bootstrap_wsl_workspace.py", "worktree:WSL_WORKSPACE.md"],
    },
    {
