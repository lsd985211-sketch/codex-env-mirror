...
def build_authorization_capsule(
    ...
    """Expose authorization needs without inventing an allow decision or scope."""
    ...
    return {
        "schema": "scoped_authorization.route_capsule.v2",
        "required": bool(required_facts),
        "status": "scope_required" if required_facts else "not_required",
        "effective_decision": "unknown" if required_facts else "not_applicable",
        "required_facts": required_facts,
        "authority": "scoped_authorization",
        ...
        "required_next_action": "provide_exact_scope_and_introspect" if required_facts else "continue_without_write_authorization",
