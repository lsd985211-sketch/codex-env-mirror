...
class WorkflowTerminalConvergenceTests(unittest.TestCase):
    ...
    def test_terminal_long_command_receipt_is_consumed_without_restart(self) -> None:
        ...
        self.assertEqual(LONG_COMMAND_RECEIPT_SCHEMA, contract["owner_contract_version"])
        self.assertEqual("shared/long_command_receipt.py follow", contract["verify_entrypoint"])
