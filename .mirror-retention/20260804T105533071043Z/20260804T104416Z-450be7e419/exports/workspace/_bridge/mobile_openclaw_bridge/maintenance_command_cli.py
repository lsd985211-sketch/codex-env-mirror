...
def register_maintenance_command_parsers(subparsers: Any) -> None:
    ...
    resource_process.add_argument("--authorization-grant-ref", default="")
    resource_process.add_argument("--authorization-thread-id", default="")
    resource_process.add_argument("--authorization-operation-id", default="")
    resource_process.add_argument("--authorization-state-root", default="")
...
def run_resource_process_command(args: Any) -> dict[str, Any]:
    ...
    return cleanup_orphan_candidates(
        ...
        authorization_grant_ref=str(args.authorization_grant_ref or ""),
        authorization_thread_id=str(args.authorization_thread_id or ""),
        authorization_operation_id=str(args.authorization_operation_id or ""),
        authorization_state_root=str(args.authorization_state_root or "") or None,
    )
