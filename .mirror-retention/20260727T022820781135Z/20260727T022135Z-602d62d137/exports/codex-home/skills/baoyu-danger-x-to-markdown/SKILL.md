...
- Confirm the source URL is an X post/thread/article before converting.
- Verify consent before first use.
- Decide media download behavior before saving the markdown.

## Output Contract

- Return the markdown path and whether media was downloaded.
- Mention consent state and any rewritten media links.
- If conversion was partial, say so explicitly.
