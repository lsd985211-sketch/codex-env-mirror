...
class ResourceEventStoreTests(unittest.TestCase):
    def test_manifest_rebuild_populates_request_and_events(self) -> None:
        with tempfile.TemporaryDirectory() as temp_dir:
                ...
                json.dumps(
                    {
                        ...
                        "receipt": {
                            ...
                            "acceptance_contract": {"signature": "accept-1"},
                            "strategy_shadow": {"signature": "shadow-1", "lane_count": 2, "duplicate_candidate_count": 1},
            ...
            self.assertEqual(entries[0]["metadata"]["acceptance_signature"], "accept-1")
            self.assertEqual(entries[0]["metadata"]["strategy_signature"], "shadow-1")
            self.assertEqual(entries[0]["metadata"]["shadow_lane_count"], 2)
