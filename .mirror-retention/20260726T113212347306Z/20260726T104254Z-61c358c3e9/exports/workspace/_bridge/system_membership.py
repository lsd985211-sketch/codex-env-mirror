...
IMPACT_RULES: list[dict[str, Any]] = [
    ...
    {"prefix": "_bridge/system_state_index.py", "systems": ["workflow", "startup"], "surfaces": ["information_entry", "state_signal", "maintenance_regression"], "reason": "The machine-readable cross-system state information entry or one of its owner signals changed."},
