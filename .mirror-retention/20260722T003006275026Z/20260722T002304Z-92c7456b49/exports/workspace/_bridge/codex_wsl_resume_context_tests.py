...
class CodexWslResumeContextTests(unittest.TestCase):
        ...
        state = {
            "local-projects": {
                ...
                "preserved": {
                    "id": "preserved",
                    "name": "preserved",
                    "rootPaths": [r"C:\Users\45543\Documents\preserved"],
                },
            },
    ...
    def test_reassigns_orphaned_project_assignment_when_cwd_matches_current_project(self) -> None:
        state = {
            "local-projects": {
                "wsl-project": {
                    "id": "wsl-project",
        ...
        receipt = project_thread_visibility(
            state,
            ["wsl-thread"],
            thread_cwds={"wsl-thread": WSL_WORKSPACE_ROOT + "/workspace"},
        )

        self.assertEqual(1, receipt["assigned_count"])
        self.assertEqual(1, receipt["reassigned_count"])
        self.assertEqual(
            "wsl-project",
